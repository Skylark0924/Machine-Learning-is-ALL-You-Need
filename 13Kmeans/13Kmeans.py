...
sys.path.append("D:/Github/Machine-Learning-is-ALL-You-Need")
...
if __name__ == "__main__":
    ...
    n_clusters = 3  # 聚类的类数
    X_train = spio.loadmat('D:/Github/Machine-Learning-is-ALL-You-Need/dataset/KMeans/data.mat')['X']
    ...
    y_kmeans = kmeans.predict(
        X_train)  # cluster index for each observation
